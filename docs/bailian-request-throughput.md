...
> 此文记录初版实现。2026-09-15 的发送入口、严格秒级限制、Token 结算及自适应配置见 [新版实现说明](request-pacing-redesign.md)。2026-09-17 的模型默认预算、并发调节和升级要求见[裁判模型与思考模式](judge-model-thinking.md#限流与部署范围)。下方初版测试数和性能数据属于历史验证记录。
